...
import { AudioLines, Hand, Loader, LogOut, Mic, MicOff } from "lucide-react";
  ...
  useEffect(() => {
    if (socket) {
      ...
      socket.addEventListener("message", (e) => {
        ...
        console.log("parsed data - msg event listener : ", parsedData);
  ...
  if (loading)
    return (
      <div className="w-screen h-screen flex items-center justify-center">
        <Loader className="w-5 h-5 animate-spin origin-center"/>
      </div>
    );
